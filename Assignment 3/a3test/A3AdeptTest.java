...
public class A3AdeptTest {
	...
	private void badParameterTestHelper(Pixel p) {
		try {
			...
			fail("X Null pointer exception detected. Should not happen if parameter validity was checked.");
		}
		catch(Exception e) {
		}
		...
		try {
			...
			fail("Y Null pointer exception detected. Should not happen if parameter validity was checked.");
		} catch(Exception e) {
		}
		try {
			p.blend(p, 1.5);
			...
			fail("Z Null pointer exception detected. Should not happen if parameter validity was checked.");
		} catch(Exception e) {
		}
		try {
			p.blend(p, -0.5);
			...
			fail("XXNull pointer exception detected. Should not happen if parameter validity was checked.");
		} catch(Exception e) {
		}
		...
		try {
			...
			fail("YYNull pointer exception detected. Should not happen if parameter validity was checked.");
		} catch(Exception e) {
		}
		try {
			p.lighten(-0.5);
			...
			fail("ZZNull pointer exception detected. Should not happen if parameter validity was checked.");
		} catch(Exception e) {
		}
		...
		try {
			...
			fail("XXXNull pointer exception detected. Should not happen if parameter validity was checked.");
		} catch(Exception e) {
		}
		try {
			p.darken(-0.5);
			...
			fail("YYYNull pointer exception detected. Should not happen if parameter validity was checked.");
		} catch(Exception e) {
		}
