...
// Implemetns the Observable Picture so if any changes are made to this picture,
//the observer will see ti
public class ObservablePictureImpl implements ObservablePicture {
	...
	// extracts a subpicture from  a picture using either two coordinates or length/height/width
	@Override
	...
	//Registers the ROI Observer with a region and without a region
	@Override
