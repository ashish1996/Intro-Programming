...
public class A7GraderTests {
	...
	public void basicRegionUnionTest() {
		...
		assertTrue(compareRegions(test_region.union(af), new RegionImpl(a, new Coordinate(f.getX(), test_region.getBottom()))));
		assertTrue(compareRegions(test_region.union(gf), new RegionImpl(g, new Coordinate(f.getX(), test_region.getTop()))));

		assertTrue(compareRegions(test_region.union(ah), new RegionImpl(a, new Coordinate(test_region.getRight(), h.getY()))));
		assertTrue(compareRegions(test_region.union(ch), new RegionImpl(c, new Coordinate(test_region.getLeft(), h.getY()))));
		...
		assertTrue(compareRegions(af.union(test_region), new RegionImpl(a, new Coordinate(f.getX(), test_region.getBottom()))));
		assertTrue(compareRegions(gf.union(test_region), new RegionImpl(g, new Coordinate(f.getX(), test_region.getTop()))));

		assertTrue(compareRegions(ah.union(test_region), new RegionImpl(a, new Coordinate(test_region.getRight(), h.getY()))));
		assertTrue(compareRegions(ch.union(test_region), new RegionImpl(c, new Coordinate(test_region.getLeft(), h.getY()))));
